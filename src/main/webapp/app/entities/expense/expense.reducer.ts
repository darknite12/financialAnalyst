...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_EXPENSE: 'expense/PARTIAL_UPDATE_EXPENSE',
...
export default (state: ExpenseState = initialState, action): ExpenseState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_EXPENSE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_EXPENSE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_EXPENSE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IExpense> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_EXPENSE,
