...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_TRANSACTION: 'transaction/PARTIAL_UPDATE_TRANSACTION',
...
export default (state: TransactionState = initialState, action): TransactionState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_TRANSACTION):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_TRANSACTION):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_TRANSACTION):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<ITransaction> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_TRANSACTION,
